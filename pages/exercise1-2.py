...
print('The result for raw pipeline: ', generation('write a book about genAI'))

generation = pipeline('text-generation', model="openai-community/gpt2-large")
print('The result for model="openai-community/gpt2-large": ', generation('write a book about genAI'))
...
print('The result with the usage of params: ', output[0]['generated_text'])

temperature_value = 0.8
top_p_value = 0.9
max_length_value = 100
generation = pipeline('summarization')
prompt = """
...
print('The result for summarization of the text: ', output[0]['summary_text'])
...
print('The result for sentiment analisys: ', sentiment_result)
...
translation_result = translation(data)
print('The result for translation: ', translation_result)